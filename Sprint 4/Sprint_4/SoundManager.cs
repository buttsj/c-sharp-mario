...
namespace Sprint4
{
    public class SoundManager
    {
        ...
        public SoundEffect coinCollect, brickBreak, grow, shrink, land, oneUp, enemyDamage, placeHolderFX;
            
        public enum songs{athletic, star}
        public enum sfx{coin, brick, grow, shrink, land, oneUp, enemyDamage}
